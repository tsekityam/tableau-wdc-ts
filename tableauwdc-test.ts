(function () {
  ...
  $(document).ready(function () {
    ...
    var hasAuth = accessToken.length > 0;
  ...
  function doAuthRedirect() {
    ...
    var url =
      config.authUrl +
      "oauth2/authenticate?response_type=code&client_id=" +
      appId +
      "&redirect_uri=" +
      config.redirectUri;
  ...
  function getVenueLikesURI(accessToken: string) {
    return (
  ...
  function updateUIWithAuthState(hasAuth: boolean) {
    if (hasAuth) {
  ...
  myConnector.getSchema = function (schemaCallback) {
    ...
    var col1 = { id: "Name", dataType: tableau.dataTypeEnum.string };
    var col2 = { id: "Latitude", dataType: tableau.dataTypeEnum.float };
    var col3 = { id: "Longitude", dataType: tableau.dataTypeEnum.float };
    var col4 = { id: "Address", dataType: tableau.dataTypeEnum.string };
